...
return [
    ...
    'description' => 'RESTful JSON API for the Bob social platform. All authenticated endpoints require a Sanctum bearer token obtained via POST /api/auth/login.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via <b>POST /api/auth/login</b> and pass it as <code>Authorization: Bearer {token}</code>.',
    ],
